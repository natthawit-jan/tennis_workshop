...
public class TennisGame2 implements TennisGame {
    ...
    public String getScore() {
        final String[] SCORE_DECODER = {"Love", "Fifteen", "Thirty", "Forty"};
        ...
        // No one wins, simply tells score
            ...
            return String.format("%s-%s", SCORE_DECODER[player1Point], SCORE_DECODER[player2Point]);
    ...
    private String equalPoint(int point) {
        if (point >= 3)
            return "Deuce";
        else if (point == 0)
            return "Love-All";
